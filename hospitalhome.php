      ...
      <td colspan="2" valign="top" bgcolor="#F5F5F5"><table width="85%" border="0">
       ...
       <table width="100%" align="center" style="height:200px;">
          ...
          <td width="1%">&nbsp;</td>
		   ...
		   <td ><div align="center" class="style6"><strong>Patient Name</strong> </div></td>
		...
		$qry1=mysqli_query($conn,"select * from  book where hname='$name'");
		while($row1=mysqli_fetch_array($qry1)){
		 ...
		 <td width="1%">&nbsp;</td>
		   ...
		   <td><div align="center"><?php echo $row1['uname'];?></div></td>
